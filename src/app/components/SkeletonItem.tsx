...
const SkeletonItem: React.FC<SkeletonProps> = ({ address, style, color, size, x, y }) => (
  <div
    style={{
      left: x,
      top: y,
  ...
  >
    ...
    <svg width={50 + Math.sqrt(size) * 10} height={50 + Math.sqrt(size) * 10} viewBox="0 0 57 135" fill="none" xmlns="http://www.w3.org/2000/svg">
