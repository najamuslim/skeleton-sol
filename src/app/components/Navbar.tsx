...
const Navbar: React.FC<SkeletonProps> = ({ style }) => (
    <div className='flex bg-black justify-between items-center py-4 px-12'>
      <div>
        <h1 className='text-[3.125rem] leading-none text-[#FFFFFF]'>SKELETON.AI</h1>
      </div>
      <form className="flex items-center overflow-hidden bg-[#FFFFFF] px-3 rounded-sm h-10 self-center">
        <button type="submit">
